...
if(isset($_GET["cod"])){
	...
	echo "<form action=formulario?5 method=post>
...
if(isset($_GET["2"])){
	echo "<label><h3>CADASTRO DO PROJETO</h3></label>
	<form action=formulario?1  method=post enctype=multipart/form-data>
	...
	<input type='text' class='col-md-9 col-xs-12' name='nome_integrante' placeholder='Nome de um integrante do grupo' required>

	<label class='col-md-12 col-xs-12'> E-mail </label>
	<input type=email' class='col-md-9 col-xs-12' name='Email' placeholder='Email' required>
