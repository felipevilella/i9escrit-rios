<div class="formulario_inscricao">
	<div class="container">
		<br><br><br><br><br>
		<form action="enviarDadosprojeto" method="post" enctype="multipart/form-data">
			<div class="row">
			...
			<div class="row" id="listintegrantes">
				...
				<div class='col-md-6 hidden' id='email0'>
					<label>Email</label>
					<div class='input-group'>
						<input type='text' class='form-control form-success' name='email0' id="email0" value="<?php echo $email; ?>"  placeholder='digite o email' aria-describedby='basic-addon1' disabled>
					</div>
