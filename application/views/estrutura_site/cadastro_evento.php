 <div class="container">
 	...
 	?></h5>
 	<form action="Cadastrarevento" method="post" enctype="multipart/form-data">
 	<div class="row">
 	...
 	<div class="row" id="integeventos">
 		<div class='col-md-6' id='nome0'>
 			<label>Nome</label>
 			<div class='input-group'>
 				<input type='text' class='form-control form-success' value="" name='nome0' id='nome0' placeholder='Digite o nome' aria-describedby='basic-addon1'>
 		...
 		<div class='col-md-6 ' id='email0'>
 			<label>Email</label>
 			<div class='input-group'>
 				<input type='text' class='form-control form-success' name='email0' id="email0" value=""  placeholder='E-mail de contato' aria-describedby='basic-addon1'>
 			</div>
